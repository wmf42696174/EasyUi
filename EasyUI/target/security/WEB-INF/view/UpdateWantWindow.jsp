...
<div class="AddCenter" style="box-shadow:0px 0px 23px 2px #fff;margin-top:-20px;width: 240px;height:380px;border-radius:4px;background: #333762;">
    <form action="<%=basePath%>/want/ChangeWant" method="post" id="myForm">
        <input type="hidden" name="id"/>
        <h1 style="width:100%;height:40px;color:#fff;text-align: center;line-height: 40px;font-size: 22px;">需求修改</h1>
        ...
        <p style="padding-left: 20px;margin-top: 10px;">
            <input type="submit" value="修改" class="change" style="border:none;color:#fff;display:inline-block;width:100px;background: #525891;cursor: pointer;border-radius: 4px;border:none;"/>
